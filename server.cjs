...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "RheumAI Biologic Response Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Rheumatology Patient";
process.env.TABLE_NAME = process.env.TABLE_NAME || "rheumatology_patient_records";
'use strict';
